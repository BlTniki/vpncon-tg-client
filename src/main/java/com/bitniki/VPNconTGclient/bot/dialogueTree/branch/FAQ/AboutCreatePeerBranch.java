...
public class AboutCreatePeerBranch extends Branch {
    ...
    private final String aboutCreatePeerText = """
            ...
            """;
    private final String aboutCreatePeerPhotoPath = "src/main/resources/static/image/aboutCreatePeer.png";
    ...
    private List<Response<?>> provideAnswer(Message message) {
        ...
        sendPhoto.setPhoto(new InputFile( new File(aboutCreatePeerPhotoPath)));
